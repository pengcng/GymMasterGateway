...
import { BookingPaymentComponent } from 'app/entities/gymMasterBookingPayment/booking-payment/booking-payment.component';
...
describe('Component Tests', () => {
  describe('BookingPayment Management Component', () => {
    let comp: BookingPaymentComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BookingPaymentComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bookingPayments && comp.bookingPayments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
